...
class DeviceChecklistController extends Controller
{
    public function create(Device $device)
    {
        $device->load([
            ...
            'linkedPeripherals.parentProperty.currentAssignment.staff.office.location',
            'linkedPeripherals.parentProperty.currentAssignment.office.location',
            'linkedPeripherals.parentProperty.currentAssignment.location',
