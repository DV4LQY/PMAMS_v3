        ...
        <div class="h-16 px-4 border-b border-gray-200 flex items-center justify-between dark:border-gray-700">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <div class="text-xs text-gray-500 -mt-0.5 dark:text-gray-400">Equipment System</div>
                </div>
            </div>
                ...
                <div class="flex items-center gap-3 shrink-0">
                    ...
                    <div class="relative">
                        ...
                        <div class="py-2">
                            ...
                            <a href="{{ route('admin.devices.index') }}" class="block px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50">Equipment</a>
                            ...
                            <div class="py-2">
                                ...
                                <a href="{{ route('admin.devices.index') }}" class="block px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-gray-700">Equipment</a>
